package mk.ukim.finki.aud_wp.bootstrap;

import lombok.Getter;
import mk.ukim.finki.aud_wp.model.*;
...
//
//        users.add(new User("iva.dodikj","id","Iva","Dodikj"));
//        users.add(new User("test","test","test","test"));
//
